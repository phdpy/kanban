...
export function configurarFiltros(tarefas, atualizarTela) {
    ...
    if (!(campoStatus instanceof HTMLSelectElement) ||
    ...
    const aplicarFiltros = () => {
        ...
        const tarefasFiltradas = tarefas.filter((tarefa) => {
            const correspondeStatus = campoStatus.value === "" ||
                tarefa.status === campoStatus.value;
            const correspondePrioridade = campoPrioridade.value === "" ||
